...
- **TOTAL ARCHITECTURE** : SEQ2SEQ 의 `ENCODER`-`DECODER` 구조를 따름
    ...
    ![02](/_post_refer_img/DataMiningTechs/3.GenerativeModeling/03-03.png){: width="100%"}
...
- **Transformer Application**
    ...
    ![06](/_post_refer_img/DataMiningTechs/3.GenerativeModeling/03-06.png){: width="100%"}
...
![03](/_post_refer_img/DataMiningTechs/3.GenerativeModeling/03-02.png){: width="100%"}
...
- **FUNCTION**
    ...
    ![01](/_post_refer_img/DataMiningTechs/3.GenerativeModeling/03-01.png){: width="100%"}
...
- **PERIODICITY**
    ...
    ![01](/_post_refer_img/DataMiningTechs/3.GenerativeModeling/03-05.png){: width="100%"}
...
![04](/_post_refer_img/DataMiningTechs/3.GenerativeModeling/03-04.png){: width="100%"}
