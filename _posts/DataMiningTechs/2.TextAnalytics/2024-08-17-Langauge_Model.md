...
- **How to Generate a Context Vector for $w_{t+1}$**
    ...
    ![03](/_post_refer_img/DataMiningTechs/2.TextAnalytics/06-03.png){: width="100%"}
...
![01](/_post_refer_img/DataMiningTechs/2.TextAnalytics/06-01.png){: width="100%"}
...
![02](/_post_refer_img/DataMiningTechs/2.TextAnalytics/06-02.png){: width="100%"}
