...
- **희소 표현(Sparse Representation)** : 하나의 단어를 하나의 차원으로 하는 $n$ 차원 공간에 단어를 표현하는 방법
    ...
    ![01](/_post_refer_img/DataMiningTechs/2.TextAnalytics/03-01.png){: width="100%"}
...
- **`EXAMPLE` "The fat cat sat on the mat"** (Where Window Size is 2)
    ...
    ![04](/_post_refer_img/DataMiningTechs/2.TextAnalytics/03-04.png){: width="100%"}
...
![02](/_post_refer_img/DataMiningTechs/2.TextAnalytics/03-02.png){: width="100%"}
...
![03](/_post_refer_img/DataMiningTechs/2.TextAnalytics/03-03.png){: width="100%"}
...
- 이진 분류 문제로 전환하기 위한 **입력과 레이블 변화**
    ...
    ![05](/_post_refer_img/DataMiningTechs/2.TextAnalytics/03-05.png){: width="100%"}

- **Negative Sampling**

    ![06](/_post_refer_img/DataMiningTechs/2.TextAnalytics/03-06.png){: width="100%"}
...
- **Optimization**
    ...
    ![07](/_post_refer_img/DataMiningTechs/2.TextAnalytics/03-07.png){: width="100%"}
