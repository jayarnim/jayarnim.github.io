...
- **TOTAL ARCHITECTURE** : SEQ2SEQ 의 `ENCODER`-`DECODER` 구조를 따름
    ...
    ![02](/_post_refer_img/DataMiningTechs/2.TextAnalytics/10-03.png){: width="100%"}
...
- **Transformer Application**
    ...
    ![06](/_post_refer_img/DataMiningTechs/2.TextAnalytics/10-06.png){: width="100%"}
...
![03](/_post_refer_img/DataMiningTechs/2.TextAnalytics/10-02.png){: width="100%"}
...
- **FUNCTION**
    ...
    ![01](/_post_refer_img/DataMiningTechs/2.TextAnalytics/10-01.png){: width="100%"}
...
- **PERIODICITY**
    ...
    ![01](/_post_refer_img/DataMiningTechs/2.TextAnalytics/10-05.png){: width="100%"}
...
![04](/_post_refer_img/DataMiningTechs/2.TextAnalytics/10-04.png){: width="100%"}
