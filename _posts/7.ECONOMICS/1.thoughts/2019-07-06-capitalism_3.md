---
order: 6
title: Industrial Capitalism (2) Thomas Malthus & David Ricardo
date: 2019-07-06
...
- **과잉생산론(Theory of Overproduction)**: 유효 수요(Effective Demand)가 확보되지 않는다면 시장 가격이 자연 가격으로 수렴하지 않는다고 보아 유효 수요 부족에 의한 불황 가능성을 제기하고 지주들의 비생산적 소비가 불황을 예방하는 필수 요소라고 주장함
...
- **투하노동가치설(Labor Embodied Theory of Value)**: 애덤 스미스(Adam Smith)의 가치론 중 생산의 시각을 계승하였음
    ...
    $$\begin{aligned}
    \lambda
    &=a\lambda+L,\quad 0<a<1\\
    (1-a)\lambda
    &=L\\
    \therefore\lambda
    &=L\cdot\frac{1}{1-a}\\
    &=L\cdot\left(1+a+a^{2}+\cdots\right)\\
    &=\underbrace{L\cdot 1}_{\text{직접 노동}}+\underbrace{L\cdot\left(a+a^{2}+\cdots\right)}_{\text{간접 노동}}
    \end{aligned}$$
