...
description: >-
    <ul type="square">
    <li><strong>Title</strong>: <a href="https://proceedings.mlr.press/v37/blundell15"><em>Weight Uncertainty in Neural Networks</em></a></li>
    <li><strong>Author</strong>: <em>Blundell et al.</em></li>
