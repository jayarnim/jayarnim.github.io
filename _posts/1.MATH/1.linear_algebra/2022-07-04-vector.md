...
- **직교 정규 벡터(Orthonomal Vector)**: 임의의 벡터에 대하여 해당 벡터와 직교하는 정규 벡터
    ...
    ![07](/assets/img/posts/1.MATH/1.linear_algebra/01-07.png){: width="100%"}
...
- **선형 종속(Linearly Dependent)** : 어떤 벡터가 다른 벡터들의 선형 결합으로 표현 가능한 경우
    ...
    ![05](/assets/img/posts/1.MATH/1.linear_algebra/01-05.jpg){: width="100%"}
...
- **선형 독립(Linearly Independent)** : 어떤 벡터가 다른 벡터들의 선형 결합으로 표현될 수 없는 경우
    ...
    ![06](/assets/img/posts/1.MATH/1.linear_algebra/01-06.jpg){: width="100%"}
