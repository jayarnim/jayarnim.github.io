...
where there is a `sequence between features`:
    ...
    ![01](/assets/img/posts/3.ML/4.neural_networks/03-01.png){: width="100%"}
...
so they do not structurally reflect `order information` between features:
    ...
    ![02](/assets/img/posts/3.ML/4.neural_networks/03-02.png){: width="100%"}

- RNN(`R`ecurrent `N`eural `N`etworks) involves `preprocessing` operations\\
that preserve `sequence information`:

    ![03](/assets/img/posts/3.ML/4.neural_networks/03-03.png){: width="100%"}


## Vanilla RNN
-----

![04](/assets/img/posts/3.ML/4.neural_networks/03-04.png){: width="100%"}
...
- vanilla rnn suffers from the problems of `long-term dependencies`:
    ...
    ![05](/assets/img/posts/3.ML/4.neural_networks/03-05.png){: width="100%"}
...
- LSTM(`L`ong `S`hort-`T`erm `M`emory) is technique to alleviate vanishing gradient through `gate adjustment`:
    ...
    ![07](/assets/img/posts/3.ML/4.neural_networks/03-07.jpeg){: width="100%"}
...
- forget gate:
    ...
    ![08](/assets/img/posts/3.ML/4.neural_networks/03-08.png){: width="100%"}

- input gate:

    ![09](/assets/img/posts/3.ML/4.neural_networks/03-09.png){: width="100%"}

- cell state:

    ![10](/assets/img/posts/3.ML/4.neural_networks/03-10.png){: width="100%"}

- output gate:

    ![11](/assets/img/posts/3.ML/4.neural_networks/03-11.png){: width="100%"}
