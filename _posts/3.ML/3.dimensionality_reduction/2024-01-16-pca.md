...
![04](/assets/img/posts/3.ML/3.dimensionality_reduction/02-04.jpeg){: width="100%"}

- **주성분 분석(`P`rincipal `C`omponent `A`nalysis)**: 고차원 데이터 $X$ 의 방향적 분포를 가장 잘 설명하는 **새로운 저차원 직교 좌표**를 학습하는 기법

    ![05](/assets/img/posts/3.ML/3.dimensionality_reduction/02-05.png){: width="100%"}
...
![04](/assets/img/posts/3.ML/3.dimensionality_reduction/02-07.png){: width="100%"}
