...
- **서포트 벡터 머신(`S`upport `V`ector `M`achine)**: 마진(Margin)을 최대로 가져가는 초평면(Hyper Plane)을 규칙으로 하여 관측치를 분류하는 알고리즘
    ...
    ![02](/assets/img/posts/3.ML/1.supervised_learning/04-02.png){: width="100%"}
...
![03](/assets/img/posts/3.ML/1.supervised_learning/04-03.png){: width="100%"}
...
![04](/assets/img/posts/3.ML/1.supervised_learning/04-04.png){: width="100%"}
...
![06](/assets/img/posts/3.ML/1.supervised_learning/04-06.png){: width="100%"}
...
- **Definition of Optimization Problem**
    ...
    - $C$ : 마진 위반에 대한 규제 강도
        ...
        ![07](/assets/img/posts/3.ML/1.supervised_learning/04-07.png){: width="100%"}
