...
![01](/assets/img/posts/3.ML/1.supervised_learning/06-01.png){: width="100%"}
...
- Bias-Variance Trade-off:
    ...
    ![02](/assets/img/posts/3.ML/1.supervised_learning/06-02.png){: width="100%"}
...
- **Bagging(`B`ootstrap `Agg`regat`ing`)** : 데이터 세트로부터 생성된 $M$ 개의 부트스트랩(Bootstrap)을 통해 $M$ 개의 개별 모형들을 병렬 학습하는 방법
    ...
    ![03](/assets/img/posts/3.ML/1.supervised_learning/06-03.png){: width="100%"}
...
- **Boosting** : 직렬로 나열된 개별 모형들에 대하여 모든 훈련 데이터 세트를 순차 학습하되, 현재 순번 모형이 오류를 줄이는 데 실패한 데이터 포인트에 대하여, 해당 포인트의 중요도를 가중함으로써 다음 모형이 더 집중하여 학습시키는 방법
    ...
    ![04](/assets/img/posts/3.ML/1.supervised_learning/06-04.png){: width="100%"}
