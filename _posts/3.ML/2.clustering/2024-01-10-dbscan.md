...
- **DBSCAN(`D`ensity-`B`ased `S`patial `C`lustering of `A`pplications with `N`oise)** : 밀도 기반 배타적 분리형 군집화 알고리즘
    ...
    ![01](/assets/img/posts/3.ML/2.clustering/03-01.png){: width="100%"}

- **군집** : 사전에 주어진 $\varepsilon, \text{MinPts}$ 에 기초했을 때 Maximality, Connectivity 조건을 만족하는 Non-Empty Subset

    ![02](/assets/img/posts/3.ML/2.clustering/03-02.png){: width="100%"}
...
![03](/assets/img/posts/3.ML/2.clustering/03-03.png){: width="100%"}
...
![04](/assets/img/posts/3.ML/2.clustering/03-04.jpg){: width="100%"}
...
![05](/assets/img/posts/3.ML/2.clustering/03-05.jpg){: width="100%"}
...
![06](/assets/img/posts/3.ML/2.clustering/03-06.jpeg){: width="100%"}
