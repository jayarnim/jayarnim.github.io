...
- **k-Means**: 중심점 기반 배타적 분리형 군집화 알고리즘으로서, 관측치와 중심점(Centroid) 간 평균 거리(Means)를 최소화하는 군집을 탐색함
    ...
    ![01](/assets/img/posts/3.ML/2.clustering/02-01.png){: width="100%"}
...
![07](/assets/img/posts/3.ML/2.clustering/02-07.png){: width="100%"}
...
- Sensitive to initial cluster centroids
    ...
    ![02](/assets/img/posts/3.ML/2.clustering/02-02.png){: width="100%"}

- Sensitive to outliers

    ![03](/assets/img/posts/3.ML/2.clustering/02-03.png){: width="100%"}

- Difficulty detecting clusters of non-spherical shapes

    ![04](/assets/img/posts/3.ML/2.clustering/02-04.png){: width="100%"}

- Difficulty detecting clusters of different sizes

    ![05](/assets/img/posts/3.ML/2.clustering/02-05.png){: width="100%"}

- Difficulty detecting clusters of different densities

    ![06](/assets/img/posts/3.ML/2.clustering/02-06.png){: width="100%"}
