...
tags: [Distribution, Discrete Variable, Categorical Dist., Multinomial Dist.]
math: true
description: >-
...
- change of variables $\eta\to\pi$:
    ...
    \\
    \sum_{k=1}^{K-1}{\eta_{k}}
    &=\sum_{k=1}^{K-1}{\log{\frac{\pi_{k}}{\pi_{K}}}}\\
    &=\sum_{k=1}^{K-1}{\left(\log{\pi_{k}}-\log{\pi_{K}}\right)}\\
    &=\sum_{k=1}^{K-1}{\log{\pi_{k}}}-(K-1)\log{\pi_{K}}\\
    \log{\left(1+\sum_{k=1}^{K-1}{\exp{\eta_{k}}}\right)}
    &=-\log{\pi_{K}}\\
    \left\vert\frac{\mathrm{\partial}\mathrm{H}}{\mathrm{\partial}\Pi}\right\vert
    &=\frac{1}{\prod_{k=1}^{K}{\pi_{k}}}\\
    \\
    \therefore p_{\Pi}(\Pi)
    ...
    &=\exp{\left[\alpha\cdot\sum_{k=1}^{K-1}{\log{\pi_{k}}}-\alpha\cdot(K-1)\log{\pi_{K}}+\beta\cdot\log{\pi_{K}}\right]}\cdot\frac{1}{\prod_{k=1}^{K}{\pi_{k}}}\\
    &=\left(\prod_{k=1}^{K-1}{\pi_{k}^{\alpha}}\right)\cdot\pi_{K}^{\beta-\alpha(K-1)}\cdot\frac{1}{\prod_{k=1}^{K-1}{\pi_{k}}}\cdot\frac{1}{\pi_{K}}\\
    &=\left(\prod_{k=1}^{K-1}{\pi_{k}^{\alpha-1}}\right)\cdot\pi_{K}^{\beta-\alpha(K-1)-1}\\
    &=\prod_{k=1}^{K}{\pi_{k}^{\alpha_{k}-1}},\quad\mathrm{for}\quad\alpha_{k}
    =\begin{cases}
    \alpha,\quad &k\ne K\\
