...
- **A/B Test vs. MAB**
    ...
    ![02](/_post_refer_img/BayesianModeling/3.Application/03-02.PNG){: width="100%"}
...
- **Selection Issue** : Exploration-Exploitation Trade-off
    ...
    ![04](/_post_refer_img/BayesianModeling/3.Application/03-03.PNG){: width="100%"}
...
![05](/_post_refer_img/BayesianModeling/3.Application/03-04.png){: width="100%"}
