...
- **Objective Function**
    ...
    - $$\overrightarrow{\mu}_{U}, \Lambda_{U}, \overrightarrow{\mu}_{V}, \Lambda_{V} \mid \mathbf{R}$$ : Joint Posterior Probability Distribution of Params
        - $$\overrightarrow{\mu}_{U}, \Lambda_{U}$$ : Conditional Prior Distribution Params of $$\mathbf{U} \sim \mathcal{N}\left(\overrightarrow{\mu}_{U}, \Lambda_{U}\right)$$
        - $$\overrightarrow{\mu}_{V}, \Lambda_{V}$$ : Conditional Prior Distribution Params of $$\mathbf{V}\sim \mathcal{N}\left(\overrightarrow{\mu}_{V}, \Lambda_{V}\right)$$
    ...
    - $$\overrightarrow{\mu}, \Lambda$$ : Marginal Prior Distribution of $$\mathbf{U}, \mathbf{V}$$ Params