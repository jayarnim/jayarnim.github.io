...
- $\text{temperature} = T(x, time)$
    ...
    ![01](/_post_refer_img/MathematicalTechs/2.Calculus/04-01.png){: width="100%"}

- $\text{temperature} = T(x,time=3)$

    ![02](/_post_refer_img/MathematicalTechs/2.Calculus/04-02.png){: width="100%"}

- $\text{temperature} = T(x) \\ (\text{s.t.} \, time=3)$

    ![03](/_post_refer_img/MathematicalTechs/2.Calculus/04-03.png){: width="100%"}

- $\displaystyle\frac{d}{dx}T(x,time=3)$

    ![04](/_post_refer_img/MathematicalTechs/2.Calculus/04-04.png){: width="100%"}
