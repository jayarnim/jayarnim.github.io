...
- **Conditional Probability**
    ...
    - $$P(B \mid A)$$ : 사건 $$A$$ 발생 조건부 사건 $$B$$ 발생 확률
...
- **베이즈 정리에 의해 다음이 성립함**
    ...
    - $$P(Y=i \mid X_{1}=x_{1},X_{2}=x_{2},\cdots,X_{n}=x_{n})$$ : 관측치 벡터 $$\overrightarrow{\mathbf{x}}=(x_{1},x_{2},\cdots,x_{n})$$ 가 주어졌을 때, 해당 관측치의 범주 $$Y$$ 가 $i$ 일 확률
