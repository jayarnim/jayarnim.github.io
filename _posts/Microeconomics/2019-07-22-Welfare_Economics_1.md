...
- **에지워스 상자(Edgeworth Box)** : 자원 분배에 따른 효용 달성 정도를 분석하는 도구로서, 두 가지 부존자원 $X,Y$ 을 보유하고 있고, 두 명의 경제주체 $A,B$ 가 활동하는 가상의 경제를 상정함
    ...
    ![01](/_post_refer_img/Microeconomics/08-01.png){: width="100%"}
...
- **초기부존자원점(Initial Endowment Point)**
    ...
    ![02](/_post_refer_img/Microeconomics/08-02.png){: width="100%"}
...
- **초기부존자원 하 효용 수준**
    ...
    ![03](/_post_refer_img/Microeconomics/08-03.png){: width="100%"}
...
- **교환하기 위한 가격체계 설정**
    ...
    ![04](/_post_refer_img/Microeconomics/08-04.png){: width="100%"}
...
- **가격체계 하 효용 극대화 지점 도출**
    ...
    <div style="text-align: center;">
        <img src="/_post_refer_img/Microeconomics/08-05.png" alt="05" width="100%">
        <p><em>$A$ 의 효용 극대화 지점 하 각 부존자원에 대한 수요량과 공급량</em></p>
    </div>

    <div style="text-align: center;">
        <img src="/_post_refer_img/Microeconomics/08-06.png" alt="06" width="100%">
...
- **왈라스 불균형**
    ...
    <div style="text-align: center;">
        <img src="/_post_refer_img/Microeconomics/08-07.png" alt="07" width="100%">
        <p><em>현재 가격체계 하에서는 두 경제주체 간 이해관계가 맞아떨어지지 않음</em></p>
    </div>

    <div style="text-align: center;">
        <img src="/_post_refer_img/Microeconomics/08-15.png" alt="15" width="100%">
        <p><em>$A$ 의 효용 극대점에서 거래를 강제하는 경우<br>$B$ 의 효용수준이 낮아짐</em></p>
    </div>

    <div style="text-align: center;">
        <img src="/_post_refer_img/Microeconomics/08-16.png" alt="16" width="100%">
        <p><em>$B$ 의 효용 극대점에서 거래를 강제하는 경우<br>$A$ 의 효용수준이 낮아짐</em></p>
    </div>

- **왈라스 불균형 하 수요량과 공급량의 불일치**

    ![09](/_post_refer_img/Microeconomics/08-09.png){: width="100%"}
    ![10](/_post_refer_img/Microeconomics/08-10.png){: width="100%"}

### Walras Equilibrium

- **모색 과정** : 왈라스 균형에 도달하기 위해 가격체계를 조정하는 과정

    ![11](/_post_refer_img/Microeconomics/08-11.png){: width="100%"}
...
- **왈라스 균형**
    ...
    ![12](/_post_refer_img/Microeconomics/08-12.png){: width="100%"}

- **왈라스 균형 하 수요량과 공급량의 일치**

    ![13](/_post_refer_img/Microeconomics/08-13.png){: width="100%"}

- **계약곡선(Contract Curve)** : 두 경제주체가 교환을 통해 효용을 극대화하는(왈라스 균형을 실현하는) 배분점의 집합

    ![14](/_post_refer_img/Microeconomics/08-14.png){: width="100%"}
