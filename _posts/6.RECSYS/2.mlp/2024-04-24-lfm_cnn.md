...
- Capture interdimensional high-level interaction of user $u$ and item $i$: 
    ...
    ![02](/assets/img/posts/6.RECSYS/2.mlp/06-02.png){: width="100%"}
...
![03](/assets/img/posts/6.RECSYS/2.mlp/06-03.png){: width="100%"}
...
![04](/assets/img/posts/6.RECSYS/2.mlp/06-04.png){: width="100%"}
