...
- **FPMC(`F`actorizing `P`ersonalized `M`arkov `C`hains)** : 개별 사용자마다 장바구니 아이템 전이행렬을 모델링하는 사용자 개인화 순차 추천 알고리즘
    ...
    ![03](/assets/img/posts/RecommenderSystem/105-03.png){: width="100%"}
...
- **문제점** : 과도한 학습파라미터 갯수
    ...
    ![01](/assets/img/posts/RecommenderSystem/105-01.png){: width="100%"}
...
- **해법** : 행렬 분해를 활용한 전이큐브 추론
    ...
    ![02](/assets/img/posts/RecommenderSystem/105-02.png){: width="100%"}
