...
- **덴드로그램(Dendrogram)**: 결합 혹은 분할하는 순서를 나타내는 계층적 트리모형
    ...
    ![01](/_post_refer_img/StatisticalTechs/3.MultivariateStatisticalAnalysis/05-01.png){: width="100%"}

- **종류**

    ![02](/_post_refer_img/StatisticalTechs/3.MultivariateStatisticalAnalysis/05-02.png){: width="100%"}
