...
![03](/_post_refer_img/2.STATS/3.regression_analysis/06-03.png){: width="100%"}
...
- Bias-Variance Trade-off:
    ...
    ![04](/_post_refer_img/2.STATS/3.regression_analysis/06-04.png){: width="100%"}
...
- **p-norm** : $n$ 차원 벡터 $\mathbf{x}=\begin{pmatrix}x_{1}&x_{2}&\cdots&x_{n}\end{pmatrix}$ 의 크기를 정의하는 방법
    ...
    ![01](/_post_refer_img/2.STATS/3.regression_analysis/06-01.png){: width="100%"}
...
- **가중치 규제(Weight Regulation)** : 회귀계수 최적값을 탐색함에 있어 회귀계수 벡터 $\beta$ 의 크기에 제약을 두는 것
    ...
    ![02](/_post_refer_img/2.STATS/3.regression_analysis/06-02.png){: width="100%"}
