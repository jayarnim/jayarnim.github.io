...
- **분산형 버전 관리 시스템의 이해**
    - **데이터 저장 방식**
        ...
        ![01](/assets/img/posts/0.ENV/1.GIT/01-01.png){: width="100%"}
    ...
    - **버전 관리 시스템**
        ...
        - **복사본을 이용한 버전 관리**
            ...
            ![02](/assets/img/posts/0.ENV/1.GIT/01-02.png){: width="100%"}

        - **버전 관리 시스템을 이용한 버전 관리**

            ![03](/assets/img/posts/0.ENV/1.GIT/01-03.png){: width="100%"}
