---
order: 5
title: Generative Model (1) Variational AutoEncoder
date: 2024-08-16
categories: [Data Mining, Image Analytics]
tags: [Data Mining, CV, Generative Model, Autoencoder, Variational Inference]
math: true
description: >-
...
- **Basic AutoEncoder** : 입력층, 잠재공간, 출력층으로 구성
    ...
    ![01](/_post_refer_img/ImageAnalytics/05-01.png){: width="100%"}
...
- **잡음 제거 오토인코더(`D`enoising `A`uto`E`ncoder; DAE)** : 원본 데이터에 잡음을 추가하여 입력한 후, 원본을 복원함으로써 잡음에 대한 강건성을 확보하고 데이터의 본질적인 특징에 집중할 수 있도록 함
    ...
    ![04](/_post_refer_img/ImageAnalytics/05-04.png){: width="100%"}
...
![05](/_post_refer_img/ImageAnalytics/05-05.png){: width="100%"}
