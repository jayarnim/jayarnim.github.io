...
![02](/assets/img/posts/5.BAYES/1.basic/05-02.png){: width="100%"}
...
- 관측치 갯수($N$)가 많아질수록 사전 확률 분포의 영향력이 약화됨
    ...
    ![01](/assets/img/posts/5.BAYES/1.basic/05-01.png){: width="100%"}
...
- 즉, 모수 $\theta$ 의 변수 변환에 의하여 사전분포의 객관성이 상실되었음
    ...
    - 변환 전 : $\theta \sim \text{Uniform}(0,1)$
        ...
        ![03](/assets/img/posts/5.BAYES/1.basic/05-03.png){: width="100%"}

    - 변환 후 : $\psi \sim \text{Logistic}(0,1)$

        ![04](/assets/img/posts/5.BAYES/1.basic/05-04.png){: width="100%"}
