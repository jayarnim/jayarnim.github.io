...
- **기계 번역(Machine Translation)** : 특정 언어로 표현된 텍스트를 다른 언어로 된 텍스트로 변환하는 과정
    ...
    ![01](/assets/img/posts/4.MODALITY/1.nlp/08-01.jpg){: width="100%"}
...
- **Architecture**
    ...
    ![02](/assets/img/posts/4.MODALITY/1.nlp/08-02.jpg){: width="100%"}
...
- **교사 강요(Teacher Forcing)** : 디코더 학습 과정에서, 다음 시점의 입력으로서 이전 시점에서 생성한 출력값 대신 정답 시퀀스를 사용하는 기법
    ...
    ![03](/assets/img/posts/4.MODALITY/1.nlp/08-03.png){: width="100%"}
